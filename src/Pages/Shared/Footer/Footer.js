        ...
        <div className="footer-bg">
            <div className="container">
                <div className="row m-0 py-3 px-2">
                    <div className="col-sm-12 col-md-12 col-lg-12">
                        <div className="row mt-4">
                            ...
                            <div className="col-sm-12 col-md-6 col-lg-2 my-2">
                                ...
                                <ul className="list-unstyled mt-3" style={{ fontSize: "14px" }}>
                                    <li className="mb-3"><a href="" target='_blank' rel='noreferrer'><FaHandPointRight className="fas fa-hand-point-right me-2" /> Admission</a></li>
                            ...
                            <div className="col-sm-12 col-md-6 col-lg-2 my-2 text-white">
                            ...
                            <div className="col-sm-12 col-md-6 col-lg-2 my-2">
                                ...
                                <div className="mt-4 d-felx">
                                    <a href="https://www.twitter.com" target='_blank' rel='noreferrer'> <AiFillTwitterCircle className="me-2 text-white follow-icon-twt " style={{ fontSize: '40px' }} /></a>
                                    <a href="https://www.facebook.com" target='_blank' rel='noreferrer' ><FaFacebook className="me-2 text-white follow-icon-fb " style={{ fontSize: '35px' }} /> </a>
                    ...
                    {/* copyright  */}
                    <p className="mt-5 text-center  m-0 fs-5">
